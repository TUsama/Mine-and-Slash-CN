...
public class Axe extends BaseWeapon implements ISpecificStatReq {
    ...
    public List<PosStats> getPossiblePrimaryStats() {
        return Arrays.asList(
                ...
                new PosStats(new PhysicalDamageFlat().size(StatMod.Size.NORMAL), new ElementalAttackDamageFlat(Elements.Nature).size(StatMod.Size.LOW)),
                new PosStats(new PhysicalDamageFlat().size(StatMod.Size.NORMAL), new ElementalAttackDamageFlat(Elements.Fire).size(StatMod.Size.LOW)),
                new PosStats(new PhysicalDamageFlat().size(StatMod.Size.NORMAL), new ElementalAttackDamageFlat(Elements.Water).size(StatMod.Size.LOW)),
                new PosStats(new PhysicalDamageFlat().size(StatMod.Size.NORMAL), new ElementalAttackDamageFlat(Elements.Thunder).size(StatMod.Size.LOW))
        );
    }
