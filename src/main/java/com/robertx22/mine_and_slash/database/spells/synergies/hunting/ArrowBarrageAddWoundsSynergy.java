...
public class ArrowBarrageAddWoundsSynergy extends OnAttackSpellDmgDoneSynergy {
    ...
    public List<ITextComponent> getSynergyTooltipInternal(TooltipInfo info) {
        ...
        list.add(new StringTextComponent(TextFormatting.GRAY + "" + TextFormatting.ITALIC + "Modifies Arrow Barrage"));
    ...
    public IAbility getRequiredAbility() {
        return ArrowBarrageSpell.getInstance();
    }
