...
public class SteamCloudEntity extends BaseCloudEntity {

    public SteamCloudEntity(World world) {
    ...
    public SteamCloudEntity(FMLPlayMessages.SpawnEntity spawnEntity, World world) {
        super(EntityRegister.STEAM_CLOUD, world);
    }
    ...
    public void onHit(LivingEntity entity) {
        ...
        this.playSound(SoundEvents.BLOCK_FIRE_EXTINGUISH, 1.0f, 1.2f);
        ...
        SoundUtils.playSound(this, SoundEvents.BLOCK_FIRE_EXTINGUISH, 1, 1.2F);
