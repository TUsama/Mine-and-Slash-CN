...
public class ImbueAddHunterSynergy extends OnBasicAttackSynergy {
    ...
    public List<ITextComponent> getSynergyTooltipInternal(TooltipInfo info) {
        ...
        list.add(new StringTextComponent("While Imbued, your attacks have a chance to"));
        list.add(new StringTextComponent("apply on self: " + HunterInstinctEffect.getInstance()
            .locNameForLangFile()));
