...
public class BonusPhysToWaterAffix extends BeneficialMapAffix {

    @Override
    public String GUID() {
        return "bonus_phys_to_water";
    }

    @Override
    public List<StatModData> Stats(int percent) {
        return Arrays.asList(StatModData.Load(new PhysToWaterConvFlat().size(StatMod.Size.NORMAL), percent));
    }
