...
public class SpellSiphonEffect extends BasePotionEffect implements IApplyStatPotion, IOneOfATypePotion {
    ...
    public static final SpellSiphonEffect INSTANCE = new SpellSiphonEffect();

    private SpellSiphonEffect() {
    ...
    public List<PotionStat> getPotionStats() {
        ...
        list.add(new PotionStat(4, SpellSteal.getInstance()));
        return list;
    }
    ...
    public BaseSpell getSpell() {
        return DraconicBloodSpell.getInstance();
    }
