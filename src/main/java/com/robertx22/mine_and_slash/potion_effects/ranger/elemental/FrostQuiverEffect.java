...
import com.robertx22.mine_and_slash.database.stats.types.offense.transfers.PhysicalToFrostTransfer;
...
public class FrostQuiverEffect extends BasePotionEffect implements IApplyStatPotion {

    public static final FrostQuiverEffect INSTANCE = new FrostQuiverEffect();

    private FrostQuiverEffect() {
    ...
    public List<PotionStat> getPotionStats() {
        ...
        list.add(new PotionStat(50, new PhysicalToFrostTransfer()));
        return list;
    }
