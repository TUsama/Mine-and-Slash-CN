...
import com.robertx22.mine_and_slash.database.stats.types.offense.transfers.PhysicalToLightningTransfer;
...
public class LightningQuiverEffect extends BasePotionEffect implements IApplyStatPotion {

    public static final LightningQuiverEffect INSTANCE = new LightningQuiverEffect();

    private LightningQuiverEffect() {
    ...
    @Override
    public String GUID() {
        return "lightning_quiver";
    }

    @Override
    public String locNameForLangFile() {
        return "Lightning Quiver";
    }
    ...
    public List<PotionStat> getPotionStats() {
        ...
        list.add(new PotionStat(50, new PhysicalToLightningTransfer()));
        return list;
    }
